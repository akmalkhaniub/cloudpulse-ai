...
Write-Host "🌐 [Cloudflare Tunnel] Launching public tunnel for CloudPulse AI at localhost:$Port..." -ForegroundColor Cyan
...
Write-Host "🚀 Tunnel active! Look for the trycloudflare.com URL below:" -ForegroundColor Green
